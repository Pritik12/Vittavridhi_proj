...
class AppColors {
  static const Color btnColor = Color(0xFF4D44B5);
  static const Color tableHeadBottom = Color(0xFFf4f9ff);
  static const Color tableTextStyle = Color(0xff4d4c4c);
  static const Color textfieldBorder = Color(0xFFD6e7ff);
